package com.areeoh.core.blockregen.listeners;

import com.areeoh.core.blockregen.BlockRegenManager;
import com.areeoh.core.blockregen.data.BlockRegenData;
...
public class BlockRegenHandler extends Module<BlockRegenManager> implements Listener, Updater {
    ...
    private final HashMap<Block, BlockRegenData> blockDataMap;
