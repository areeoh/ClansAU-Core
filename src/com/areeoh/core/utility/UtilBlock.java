...
public class UtilBlock {
    ...
    public static boolean airFoliage(byte block) {
        if (blockAirFoliageSet.isEmpty()) {
            ...
            blockAirFoliageSet.add(Byte.valueOf((byte)102));
            blockAirFoliageSet.add(Byte.valueOf((byte)-81));
            blockAirFoliageSet.add(Byte.valueOf((byte)-90));
            blockAirFoliageSet.add(Byte.valueOf((byte)67));
            blockAirFoliageSet.add(Byte.valueOf((byte)68));
            blockAirFoliageSet.add(Byte.valueOf((byte)77));
            blockAirFoliageSet.add(Byte.valueOf((byte)-113));
            blockAirFoliageSet.add(Byte.valueOf((byte)-73));
            blockAirFoliageSet.add(Byte.valueOf((byte)-72));
            blockAirFoliageSet.add(Byte.valueOf((byte)-71));
            blockAirFoliageSet.add(Byte.valueOf((byte)-70));
            blockAirFoliageSet.add(Byte.valueOf((byte)-69));
        }
